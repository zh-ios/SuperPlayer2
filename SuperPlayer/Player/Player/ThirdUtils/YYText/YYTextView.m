...
- (NSArray *)_localizedUndoStrings {
    ...
    dispatch_once(&onceToken, ^{
        NSDictionary *dic = @{
            ...
            @"ja" : @[ @"キャンセル", kZHLocalizedString(@"やり直す"), kZHLocalizedString(@"やり直す - 入力"), kZHLocalizedString(@"取り消す"), kZHLocalizedString(@"取り消す - 入力") ],
            ...
            @"zh" : @[ kZHLocalizedString(@"取消"), kZHLocalizedString(@"重做"), kZHLocalizedString(@"重做键入"), kZHLocalizedString(@"撤销"), kZHLocalizedString(@"撤销键入") ],
            @"zh_CN" : @[ kZHLocalizedString(@"取消"), kZHLocalizedString(@"重做"), kZHLocalizedString(@"重做键入"), kZHLocalizedString(@"撤销"), kZHLocalizedString(@"撤销键入") ],
            @"zh_HK" : @[ kZHLocalizedString(@"取消"), kZHLocalizedString(@"重做"), kZHLocalizedString(@"重做輸入"), kZHLocalizedString(@"還原"), kZHLocalizedString(@"還原輸入") ],
            @"zh_TW" : @[ kZHLocalizedString(@"取消"), kZHLocalizedString(@"重做"), kZHLocalizedString(@"重做輸入"), kZHLocalizedString(@"還原"), kZHLocalizedString(@"還原輸入") ]
        };
