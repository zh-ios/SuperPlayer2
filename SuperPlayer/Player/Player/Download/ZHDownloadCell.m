...
@property (nonatomic, strong) HWDownloadModel *downloadModel;
...
- (void)initSubviews {
    // 18 + 10 + 10 + 15 + 10 /// 
    self.nameLabel = [[BaseLabel alloc] initWithFrame:CGRectMake(kDownloadCellLeftPadding, 10, kScreenWidth - 150, 18)];
    self.nameLabel.font = [UIFont systemFontOfSize:15];
    self.nameLabel.textColor = kTextColor3;
    [self.contentView addSubview:self.nameLabel];
    
    self.fileSizeLabel = [[BaseLabel alloc] initWithFrame:CGRectMake(self.nameLabel.left, self.nameLabel.bottom + 10, 50, 15)];
    ...
    self.progressLabel = [[BaseLabel alloc] initWithFrame:CGRectMake(self.fileSizeLabel.right + 20, self.fileSizeLabel.top, 50, self.fileSizeLabel.height)];
