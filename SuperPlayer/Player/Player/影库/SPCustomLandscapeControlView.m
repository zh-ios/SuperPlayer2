...
@interface SPCustomLandscapeControlView () <ZFSliderViewDelegate>
...
@implementation SPCustomLandscapeControlView
...
- (void)layoutSubviews {
    ...
    self.downloadButton.frame = CGRectMake(kScreenWidth-50, min_y, min_w, min_h);
