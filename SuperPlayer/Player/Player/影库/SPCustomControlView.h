...
///////  完全复制SDK的controlView 功能，为了更好自定界面等 

@interface SPCustomControlView : UIView <ZFPlayerMediaControl>

/// 自定义的竖屏控制层的View
@property (nonatomic, strong, readonly) SPCustomPortraitControlView *portraitControlView;

/// 自定义的竖屏控制层的View
@property (nonatomic, strong, readonly) SPCustomLandscapeControlView *landScapeControlView;
