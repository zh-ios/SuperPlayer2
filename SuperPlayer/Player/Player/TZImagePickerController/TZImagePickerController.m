...
- (void)viewDidLoad {
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = kThemeEndColor;
    self.oKButtonTitleColorDisabled = [kThemeEndColor colorWithAlphaComponent:0.7];
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations {
    if ([self.topViewController isKindOfClass:TZSPVideoPlayerController.class] && self.topViewController.presentedViewController) {
