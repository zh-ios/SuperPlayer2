...
{
    NSArray *dateCharArray = @[kZHLocalizedString(@"年"), kZHLocalizedString(@"月")];
    NSArray *timeCharArray = @[kZHLocalizedString(@"时"), kZHLocalizedString(@"分"), kZHLocalizedString(@"点")];
    NSArray *needSpaceCharArray = @[kZHLocalizedString(@"日"), kZHLocalizedString(@"秒")];
...
//    NSTimeInterval netInterval = kZHLocalizedString(@"获取网络时间");
